        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold !leading-tight">
              Banking for the <span className="gradient-text">digital world</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-lg">
              Send, receive, and manage your money with unprecedented ease and security. 
              No borders, no limits, just seamless financial freedom.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Button size="lg" className="bg-wallet-purple hover:bg-wallet-dark-purple text-white rounded-xl px-8 h-14 text-lg">
                Get Started
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button size="lg" variant="outline" className="border-wallet-purple text-wallet-purple hover:bg-wallet-light-purple rounded-xl px-8 h-14 text-lg">
                See How It Works
              </Button>
            </div>
...
/>
              ...
              <div className="absolute -top-10 -left-10 bg-white dark:bg-gray-900 p-3 rounded-2xl shadow-xl animate-float" style={{ animationDelay: "1.5s" }}>
