...
const Login: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      // Navigate to dashboard/home after successful login or signup
      navigate('/');
    } catch (error) {
      toast({
        title: "Error",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto pt-10 pb-24 px-4">
        <Link to="/" className="inline-flex items-center gap-2 label-mono mb-10 hover:text-lime">
        ...
        <div className="tile p-7">
          ...
          <Button variant="outline" className="w-full h-11 rounded-full bg-surface-2 border-border hover:border-lime/60 mono text-foreground">
          ...
          <div className="text-center label-mono mt-6">
